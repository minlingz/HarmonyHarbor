...
plt.fill_between(
    yearly_averages.index, yearly_averages["duration"], color="skyblue", alpha=0.4
)
plt.plot(
    yearly_averages.index,
    yearly_averages["duration"],
    color="Slateblue",
    alpha=0.6,
...
plt.fill_between(
    yearly_averages.index, yearly_averages["tempo"], color="olive", alpha=0.3
)
plt.plot(
    yearly_averages.index,
    yearly_averages["tempo"],
    color="olivedrab",
    alpha=0.6,
...
for col in columns:
    artist_analysis[col] = (artist_analysis[col] - artist_analysis[col].min()) / (
